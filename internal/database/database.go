...
type NodePool struct {
	...
	TrafficResetMode         string            `gorm:"column:traffic_reset_mode;type:varchar(24);default:'fixed_day'" json:"traffic_reset_mode"` // 重置方式: off|fixed_day|calendar_month|interval_days
